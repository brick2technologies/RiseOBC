            ...
            <div className="hidden lg:flex items-center space-x-10">
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    to={link.to}
                    className="text-base font-semibold group text-[#03355F] transition-all duration-300"
                  >
              ...
              <div className="px-6 space-y-5">
                ...
                <div className="pt-6 space-y-4">
                  <motion.button
                    ...
                    whileHover={{ scale: 1.07, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-6 py-2.5 rounded-xl bg-[#01A3EB] text-white font-semibold shadow-lg hover:bg-[#028ac7]"
                  >
                    Join the Movement
                  </motion.button>

                  {/* MOBILE Open Volunteer */}
                  <motion.button
                    onClick={() => {
